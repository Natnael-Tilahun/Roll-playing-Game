(function(){const t=document.createElement("link").relList;if(t&&t.supports&&t.supports("modulepreload"))return;for(const e of document.querySelectorAll('link[rel="modulepreload"]'))c(e);new MutationObserver(e=>{for(const a of e)if(a.type==="childList")for(const s of a.addedNodes)s.tagName==="LINK"&&s.rel==="modulepreload"&&c(s)}).observe(document,{childList:!0,subtree:!0});function o(e){const a={};return e.integrity&&(a.integrity=e.integrity),e.referrerpolicy&&(a.referrerPolicy=e.referrerpolicy),e.crossorigin==="use-credentials"?a.credentials="include":e.crossorigin==="anonymous"?a.credentials="omit":a.credentials="same-origin",a}function c(e){if(e.ep)return;e.ep=!0;const a=o(e);fetch(e.href,a)}})();const u={hero:{name:"Wizard",avatar:"public/wizard.png",health:60,diceCount:3,currentDiceScore:[]},orc:{name:"Orc",avatar:"public/orc.png",health:30,diceCount:1,currentDiceScore:[]},demon:{name:"Demon",avatar:"public/demon.png",health:25,diceCount:2,currentDiceScore:[]},goblin:{name:"Goblin",avatar:"public/goblin.png",health:20,diceCount:3,currentDiceScore:[]}};function p(r){return new Array(r).fill(0).map(()=>Math.floor(Math.random()*6)+1)}const b=(r,t)=>100*r/t;function y(r){return new Array(r).fill(0).map(()=>'<div class="placeholder-dice"></div>').join("")}class m{constructor(t){Object.assign(this,t),this.maxHealth=this.health,this.diceHtml=y(this.diceCount)}setDiceHtml(){this.currentDiceScore=p(this.diceCount),this.diceHtml=this.currentDiceScore.map(t=>`<div class="dice">${t}</div>`).join("")}takeDamage(t){const o=t.reduce((c,e)=>c+e);this.health-=o,this.health<=0&&(this.dead=!0,this.health=0)}getHealthBarHtml(){const t=b(this.health,this.maxHealth);return`<div class="health-bar-outer">
